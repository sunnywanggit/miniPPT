...
var settings = document.getElementsByClassName('icon')[0];
...
function start() {
  var TPL = '# One Slide';
  var html = convertRaw(raw || TPL);
  slides.innerHTML = html; // More info https://github.com/hakimel/reveal.js#configuration
